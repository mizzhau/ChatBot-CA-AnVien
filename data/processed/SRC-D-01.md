...
2. Hiện đại hóa các trung tâm chỉ huy giao thông; bảo đảm kết nối, chia sẻ Cơ sở dữ liệu về trật tự, an toàn giao thông đường bộ giữa các cơ quan nhà nước có liên quan.
...
15. Đe dọa, xúc phạm, tranh giành, lôi kéo hành khách; đe dọa, cưỡng ép hành khách sử dụng dịch vụ ngoài ý muốn; chuyển tải, xuống khách hoặc các hành vi khác nhằm trốn tránh phát hiện xe chở quá tải, quá số người theo quy định của pháp luật.
...
3. Khi chở trẻ em dưới 10 tuổi và chiều cao dưới $1,35	ext{ m}$ trên xe ô tô không được cho trẻ em ngồi cùng hàng ghế với người lái xe, trừ loại xe ô tô chỉ có một hàng ghế; người lái xe phải sử dụng, hướng dẫn sử dụng thiết bị an toàn phù hợp cho trẻ em.
...
4. **Người điều khiển phương tiện tham gia giao thông đường bộ không được dừng xe, đỗ xe tại các vị trí sau đây:**  
   ...
   e) Cách xe ô tô đang đỗ ngược chiều dưới $20	ext{ m}$ trên đường phố hẹp, dưới $40	ext{ m}$ trên đường có một làn xe cơ giới trên một chiều đường;  
   g) Trên phần đường dành cho người đi bộ qua đường;  
   h) Nơi đường giao nhau và trong phạm vi $05	ext{ m}$ tính từ mép đường giao nhau;  
   i) Điểm đón, trả khách;  
   k) Trước cổng và trong phạm vi $05	ext{ m}$ hai bên cổng trụ sở cơ quan, tổ chức có bố trí đường cho xe ra, vào;  
...
2. Chỉ được dừng xe, đỗ xe ở nơi quy định; trường hợp gặp sự cố kỹ thuật hoặc bất khả kháng khác buộc phải dừng xe, đỗ xe thì được dừng xe, đỗ xe ở làn dừng khẩn cấp cùng chiều xe chạy và phải có báo hiệu bằng đèn khẩn cấp; trường hợp xe không thể di chuyển được vào làn dừng khẩn cấp, phải có báo hiệu bằng đèn khẩn cấp và đặt biển hoặc đèn cảnh báo về phía sau xe khoảng cách tối thiểu $150	ext{ m}$, nhanh chóng báo cho cơ quan Cảnh sát giao thông thực hiện nhiệm vụ bảo đảm trật tự, an toàn giao thông trên tuyến hoặc cơ quan quản lý đường cao tốc.
...
5. Hàng hóa xếp trên xe thô sơ phải bảo đảm an toàn, không gây cản trở giao thông và che khuất tầm nhìn của người điều khiển. Hàng hóa xếp trên xe không vượt quá $1/3$ chiều dài thân xe và không vượt quá $01	ext{ m}$ phía trước và phía sau xe; không vượt quá $0,4	ext{ m}$ mỗi bên bánh xe.
...
5. Xe mô tô, xe gắn máy không được xếp hàng hóa vượt quá chiều rộng giá đèo hàng về mỗi bên $0,3	ext{ m}$, vượt quá về phía sau giá đèo hàng $0,5	ext{ m}$ theo thiết kế của nhà sản xuất; chiều cao xếp hàng hóa tính từ mặt đường xe chạy không vượt quá $02	ext{ m}$.
...
1. **Xe cơ giới bao gồm:**  
   ...
   d) **Xe chở người bốn bánh có gắn động cơ** là xe có từ bốn bánh trở lên, chạy bằng động cơ, được thiết kế, sản xuất để hoạt động trên đường bộ, có kết cấu để chở người, vận tốc thiết kế không lớn hơn $30	ext{ km/h}$, số người cho phép chở tối đa 15 người (không kể người lái xe);  
   đ) **Xe chở hàng bốn bánh có gắn động cơ** là xe có từ bốn bánh trở lên, chạy bằng động cơ, được thiết kế, sản xuất để hoạt động trên đường bộ, có kết cấu để chở hàng, có phần động cơ và thùng hàng lắp trên cùng một khung xe, có tối đa hai hàng ghế và chở tối đa 05 người (không kể người lái xe), vận tốc thiết kế không lớn hơn $60	ext{ km/h}$ và khối lượng bản thân không lớn hơn $550	ext{ kg}$; trường hợp xe sử dụng động cơ điện thì có công suất động cơ không lớn hơn $15	ext{ kW}$;  
   e) **Xe mô tô** gồm: xe có hai hoặc ba bánh chạy bằng động cơ, được thiết kế, sản xuất để hoạt động trên đường bộ, trừ xe gắn máy; đối với xe ba bánh thì khối lượng bản thân không lớn hơn $400	ext{ kg}$;  
   g) **Xe gắn máy** là xe có hai hoặc ba bánh chạy bằng động cơ, được thiết kế, sản xuất để hoạt động trên đường bộ, có vận tốc thiết kế không lớn hơn $50	ext{ km/h}$; nếu động cơ dẫn động là động cơ nhiệt thì dung tích làm việc hoặc dung tích tương đương không lớn hơn $50	ext{ cm}^3$; nếu động cơ dẫn động là động cơ điện thì công suất của động cơ không lớn hơn $04	ext{ kW}$; xe gắn máy không bao gồm xe đạp máy;  
...
2. **Xe thô sơ bao gồm:**  
   ...
   b) Xe đạp máy, gồm cả xe đạp điện, là xe đạp có trợ lực từ động cơ, nguồn động lực từ động cơ bị ngắt khi người lái xe dừng đạp hoặc khi xe đạt tới tốc độ $25	ext{ km/h}$;  
   c) Xe xích lô;  
...
1. **Việc sử dụng xe mô tô, xe gắn máy, xe thô sơ để vận chuyển hành khách, hàng hóa phải thực hiện các quy định sau đây:**  
   ...
   c) Kiểm tra việc sắp xếp hàng hóa bảo đảm an toàn; không chở quá số người, chở hành lý, hàng hóa vượt quá khối lượng cho phép hoặc vượt quá khổ giới hạn của xe;  
   ...
   e) Khi vận chuyển hàng hóa xếp vượt phía trước và phía sau xe thì ban ngày phải có báo hiệu màu đỏ tại điểm đầu và điểm cuối cùng của hàng hóa, ban đêm hoặc khi trời tối phải có đèn hoặc báo hiệu cho người tham gia giao thông đường bộ để nhận biết.
...
1. **Khi vận chuyển hàng hóa bằng xe ô tô, người lái xe phải thực hiện các quy định sau đây:**  
   ...
   c) Kiểm tra việc sắp xếp hàng hóa bảo đảm an toàn; không chở hàng hóa vượt quá khối lượng cho phép hoặc vượt quá khổ giới hạn của xe;  
   ...
   đ) Khi vận chuyển hàng rời, vật liệu xây dựng, phế thải phải che đậy kín, không để rơi vãi xuống đường, gây ra tiếng ồn hoặc bụi bẩn trong suốt quá trình vận chuyển trên đường và chiều cao tối đa của hàng hóa phải thấp hơn mép trên thành thùng xe tối thiểu $10	ext{ cm}$;  
   e) Khi vận chuyển hàng hóa xếp vượt phía trước và phía sau xe thì ban ngày phải có báo hiệu màu đỏ tại điểm đầu và điểm cuối cùng của hàng hóa, ban đêm hoặc khi trời tối phải có đèn hoặc báo hiệu cho người tham gia giao thông đường bộ để nhận biết.
...
2. Việc vận chuyển hàng hóa nguy hiểm phải có giấy phép vận chuyển; trong trường hợp cần thiết, đơn vị vận chuyển hàng hóa nguy hiểm phải bố trí người áp tải để bảo đảm trật tự, an toàn giao thông đường bộ.
3. Xe ô tô vận chuyển hàng hóa nguy hiểm phải dán biểu trưng nhận diện hàng hóa nguy hiểm; lắp đèn, tín hiệu cảnh báo.
...
3. **Xe quá khổ giới hạn, xe quá tải trọng, xe bánh xích được cấp giấy phép lưu hành xe trên đường bộ trong các trường hợp sau đây:**  
   ...
   b) Lưu hành xe quá khổ giới hạn, xe quá tải trọng để chở hàng hóa trên đường bộ trong các trường hợp: phục vụ nhiệm vụ quốc phòng, an ninh; phòng, chống, khắc phục hậu quả thiên tai; thực hiện nhiệm vụ trong trường hợp khẩn cấp; chở hàng siêu trường, siêu trọng khi các phương thức vận chuyển hàng hóa bằng đường sắt, đường thủy nội địa, hàng không, hàng hải không phù hợp hoặc phải kết hợp phương thức vận tải đường bộ với phương thức vận tải khác;  
   c) Lưu hành xe quá khổ giới hạn cho phép của xe để chở xe ô tô chở người đến 08 chỗ (không kể chỗ của người lái xe), xe ô tô tải và ô tô chuyên dùng có khối lượng toàn bộ theo thiết kế đến $3.500	ext{ kg}$ từ nơi sản xuất, ga, cảng và các địa điểm nhập khẩu, sửa chữa, bảo trì đến nơi sử dụng.
...
1. **Giấy phép lái xe bao gồm các hạng sau đây:**  
   a) **Hạng A1** cấp cho người lái xe mô tô hai bánh có dung tích xi-lanh đến $125	ext{ cm}^3$ hoặc có công suất động cơ điện đến $11	ext{ kW}$;  
   b) **Hạng A** cấp cho người lái xe mô tô hai bánh có dung tích xi-lanh trên $125	ext{ cm}^3$ hoặc có công suất động cơ điện trên $11	ext{ kW}$ và các loại xe quy định cho giấy phép lái xe hạng A1;  
   c) **Hạng B1** cấp cho người lái xe mô tô ba bánh và các loại xe quy định cho giấy phép lái xe hạng A1;  
   d) **Hạng B** cấp cho người lái xe ô tô chở người đến 08 chỗ (không kể chỗ của người lái xe); xe ô tô tải và ô tô chuyên dùng có khối lượng toàn bộ theo thiết kế đến $3.500	ext{ kg}$; các loại xe ô tô quy định cho giấy phép lái xe hạng B kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$;  
   đ) **Hạng C1** cấp cho người lái xe ô tô tải và ô tô chuyên dùng có khối lượng toàn bộ theo thiết kế trên $3.500	ext{ kg}$ đến $7.500	ext{ kg}$; các loại xe ô tô tải quy định cho giấy phép lái xe hạng C1 kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$; các loại xe quy định cho giấy phép lái xe hạng B;  
   e) **Hạng C** cấp cho người lái xe ô tô tải và ô tô chuyên dùng có khối lượng toàn bộ theo thiết kế trên $7.500	ext{ kg}$; các loại xe ô tô tải quy định cho giấy phép lái xe hạng C kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$; các loại xe quy định cho giấy phép lái xe hạng B và hạng C1;  
   g) **Hạng D1** cấp cho người lái xe ô tô chở người trên 08 chỗ (không kể chỗ của người lái xe) đến 16 chỗ (không kể chỗ của người lái xe); các loại xe ô tô chở người quy định cho giấy phép lái xe hạng D1 kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$; các loại xe quy định cho giấy phép lái xe các hạng B, C1, C;  
   h) **Hạng D2** cấp cho người lái xe ô tô chở người (kể cả xe buýt) trên 16 chỗ (không kể chỗ của người lái xe) đến 29 chỗ (không kể chỗ của người lái xe); các loại xe ô tô chở người quy định cho giấy phép lái xe hạng D2 kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$; các loại xe quy định cho giấy phép lái xe các hạng B, C1, C, D1;  
   i) **Hạng D** cấp cho người lái xe ô tô chở người (kể cả xe buýt) trên 29 chỗ (không kể chỗ của người lái xe); xe ô tô chở người giường nằm; các loại xe ô tô chở người quy định cho giấy phép lái xe hạng D kéo rơ moóc có khối lượng toàn bộ theo thiết kế đến $750	ext{ kg}$; các loại xe quy định cho giấy phép lái xe các hạng B, C1, C, D1, D2;  
   k) **Hạng BE** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng B kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$;  
   l) **Hạng C1E** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng C1 kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$;  
   m) **Hạng CE** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng C kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$; xe ô tô đầu kéo kéo sơ mi rơ moóc;  
   n) **Hạng D1E** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng D1 kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$;  
   o) **Hạng D2E** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng D2 kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$;  
   p) **Hạng DE** cấp cho người lái các loại xe ô tô quy định cho giấy phép lái xe hạng D kéo rơ moóc có khối lượng toàn bộ theo thiết kế trên $750	ext{ kg}$; xe ô tô chở khách nối toa.
...
2. **Giấy phép lái xe được cấp trước ngày Luật này có hiệu lực thi hành nếu chưa thực hiện đổi, cấp lại theo quy định của Luật này có hiệu lực sử dụng như sau:**  
   a) Giấy phép lái xe hạng A1 được tiếp tục điều khiển xe mô tô hai bánh có dung tích xi-lanh từ $50	ext{ cm}^3$ đến dưới $175	ext{ cm}^3$ hoặc có công suất động cơ điện từ $04	ext{ kW}$ đến dưới $14	ext{ kW}$;  
   b) Giấy phép lái xe hạng A2 được tiếp tục điều khiển xe mô tô hai bánh có dung tích xi-lanh từ $175	ext{ cm}^3$ trở lên hoặc có công suất động cơ điện từ $14	ext{ kW}$ trở lên và các loại xe quy định cho giấy phép lái xe hạng A1 quy định tại điểm a khoản này;  
   ...
   d) Giấy phép lái xe hạng A4 được tiếp tục điều khiển máy kéo có trọng tải đến $1.000	ext{ kg}$;  
   đ) Giấy phép lái xe hạng B1 số tự động cấp cho người không hành nghề lái xe được tiếp tục điều khiển xe ô tô số tự động chở người đến 08 chỗ (không kể chỗ của người lái xe); xe ô tô tải, kể cả ô tô tải chuyên dùng số tự động có trọng tải dưới $3.500	ext{ kg}$;  
   e) Giấy phép lái xe hạng B1 cấp cho người không hành nghề lái xe được tiếp tục điều khiển xe ô tô chở người đến 08 chỗ (không kể chỗ của người lái xe); xe ô tô tải, máy kéo có trọng tải dưới $3.500	ext{ kg}$;  
   g) Giấy phép lái xe hạng B2 cấp cho người hành nghề lái xe được tiếp tục điều khiển xe ô tô chở người đến 08 chỗ (không kể chỗ của người lái xe); xe ô tô tải, máy kéo có trọng tải dưới $3.500	ext{ kg}$;  
   h) Giấy phép lái xe hạng C được tiếp tục điều khiển xe ô tô tải, máy kéo có trọng tải từ $3.500	ext{ kg}$ trở lên và các loại xe quy định cho các giấy phép lái xe hạng B1, B2 quy định tại các điểm đ, e và g khoản này;  
...
3. **Trường hợp người có giấy phép lái xe đã được cấp trước ngày Luật này có hiệu lực thi hành có nhu cầu đổi, cấp lại giấy phép lái xe thì thực hiện như sau:**  
   a) Giấy phép lái xe hạng A1 được đổi, cấp lại sang giấy phép lái xe hạng A với điều kiện hạn chế là chỉ được điều khiển xe mô tô hai bánh có dung tích xi-lanh đến dưới $175	ext{ cm}^3$ hoặc có công suất động cơ điện đến dưới $14	ext{ kW}$;  
   ...
   d) Giấy phép lái xe hạng A4 được đổi, cấp lại sang chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải đến $1.000	ext{ kg}$ và chứng chỉ bồi dưỡng kiến thức pháp luật về giao thông đường bộ cho người điều khiển xe máy chuyên dùng;  
   ...
   e) Giấy phép lái xe hạng B1, B2 được đổi, cấp lại sang giấy phép lái xe hạng B hoặc hạng C1 và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải đến $3.500	ext{ kg}$;  
   g) Giấy phép lái xe hạng C giữ nguyên và đổi, cấp lại cùng hạng và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$;  
   h) Giấy phép lái xe hạng D được đổi, cấp lại sang giấy phép lái xe hạng D2 và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$;  
   i) Giấy phép lái xe hạng E được đổi, cấp lại sang giấy phép lái xe hạng D và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$;  
   k) Giấy phép lái xe hạng FB2 được đổi, cấp lại sang giấy phép lái xe hạng BE hoặc hạng C1E và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải đến $3.500	ext{ kg}$;  
   l) Giấy phép lái xe hạng FC được đổi, cấp lại sang giấy phép lái xe hạng CE và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$;  
   m) Giấy phép lái xe hạng FD được đổi, cấp lại sang giấy phép lái xe hạng D2E và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$;  
   n) Giấy phép lái xe hạng FE được đổi, cấp lại sang giấy phép lái xe hạng DE và chứng chỉ điều khiển xe máy chuyên dùng cho người điều khiển máy kéo có trọng tải trên $3.500	ext{ kg}$.
